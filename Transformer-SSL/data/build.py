...
class stain_norm(object):
    def get_stain_normalizer(self, path=config.AUG.STAIN_NORM_REF_PATH'/home/users/rikiya/SSL-Transformer-Histopathology/Transformer-SSL/stain_norm_ref.png', method='macenko'):
