...
parser.add_argument('--extensions', nargs='+', type=str, default=['png', 'jpeg', 'jpg', 'tif'], \
...
parser.add_argument('--style-size', type=int, default=1024,
        ...
        for content_path in content_paths:
            try:
                ...
                for style_path in random.sample(styles, args.num_styles):
                    ...
                    out_dir = output_dir.joinpath(rel_path.parent, content_path.stem)
                    ...
                    out_filename = content_name + '-stylized-' + style_name + '.png'
                    output_name = out_dir.joinpath(out_filename)

                    if args.upto and len(list(out_dir.rglob('*.png'))) >= args.upto:
                        continue
...
# Use Case
# """
# python stylize_dataset.py --content-dir '/scratch/groups/rubin/rikiya/ssl_pretrain_tiny/train/0/' --style-dir '/scratch/users/rikiya/paintings/' --output-dir '/scratch/groups/rubin/rikiya/ssl_pretrain_tiny_stylized/train/0/' --num-styles 32 --content-size 1024 --style-size 256
# """