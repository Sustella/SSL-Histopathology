...
def parse_option():
    ...
    parser.add_argument('--stain_norm_ref_path', type=str, default='/home/users/stellasu/linear_eval_branch/SSL-Transformer-Histopathology/Transformer-SSL/stain_norm_ref.png', help='path to stain norm reference images')
